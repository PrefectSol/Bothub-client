...
class NetworkInterface:
    ...
    def generate_user(permissions: Permissions) -> dict:
        data = {
            "permissions": {
                "hostManagement": permissions.get_host_permission(),
    ...
    def create_host(self, host: dict):
        ...
        response = requests.post(
            url=f"{NetworkInterface.server_url}/createhost", json=data
        )
    ...
    def delete_host(self, host_id):
        ...
        response = requests.post(
            url=f"{NetworkInterface.server_url}/deletehost", json=data
        )
    ...
    def post_bot(self, bot_source, host_id):
        ...
        response = requests.post(
            url=f"{NetworkInterface.server_url}/postbot", json=data
        )
